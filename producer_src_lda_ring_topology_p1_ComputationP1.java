 ...
 */
public class ComputationP1 {
    LDAUtils ldaUtils=new LDAUtils();

    ArrayList<BigInteger> getAttributesMean(){
        List<Double> Temp_Y = new ArrayList<Double>(Arrays.asList(83.0, 70.0, 68.0));
        List<Double> Hum_Y = new ArrayList<Double>(Arrays.asList(78.0, 96.0, 80.0));
